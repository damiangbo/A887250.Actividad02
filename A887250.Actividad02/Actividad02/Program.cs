    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           for (int indice=0; indice < cantOperadores; indice++)
            ...
            // Cola de ordenes hardcodeada, van a ser 9 ordenes a asignar a algún operador
            Dictionary<int, List<int>> operadores = new Dictionary<int, List<int>>();
            //Los operadores están represnetados por un entero y las ordenes como lista para poder asignar varias ordenes a un mismo operador
            int op = -1;
            while (op != 999 && colaDeOrdenes.Count > 0)
            {
                ...
                //Recorre el diccionario y recorriendo primero la key y luego los valores de la lista
